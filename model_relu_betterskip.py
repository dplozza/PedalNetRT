...
# Diffierent implementation of skip connections: from output of residual layers, istead of before residual addition....
...
class WaveNet(nn.Module):
    def __init__(self, num_channels, dilation_depth, num_repeat, kernel_size=2,dilation_power=2,in_bit_depth='None'):
        """
        Args:
